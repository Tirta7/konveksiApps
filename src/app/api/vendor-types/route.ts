...
const DEFAULT_TYPES = [
  { id: 1, nama: "CMT / Penjahit", slug: "cmt", emoji: "", perlu_portal: true, portal_path: "/cmt", perlu_gaji: true, perlu_throttle: true, createdAt: new Date().toISOString() },
  { id: 2, nama: "Washing / Laundry", slug: "washing", emoji: "", perlu_portal: true, portal_path: "/washing", perlu_gaji: true, perlu_throttle: true, createdAt: new Date().toISOString() },
  { id: 3, nama: "Bersih Benang", slug: "benang", emoji: "", perlu_portal: true, portal_path: "/bersih-benang", perlu_gaji: true, perlu_throttle: true, createdAt: new Date().toISOString() },
  { id: 4, nama: "QC / Finishing", slug: "finishing", emoji: "", perlu_portal: true, portal_path: "/finishing", perlu_gaji: false, perlu_throttle: false, createdAt: new Date().toISOString() },
  { id: 5, nama: "Lainnya", slug: "lainnya", emoji: "", perlu_portal: false, portal_path: "", perlu_gaji: false, perlu_throttle: false, createdAt: new Date().toISOString() },
];
...
export async function POST(req: NextRequest) {
  ...
  const newType = { id, nama, slug, emoji: emoji || "", perlu_portal: !!perlu_portal, portal_path: portal_path || "", perlu_gaji: !!perlu_gaji, perlu_throttle: !!perlu_throttle, createdAt: new Date().toISOString() };
